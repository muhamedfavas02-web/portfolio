          ...
          <div className="hero-left">
            ...
            >
              <svg viewBox="0 0 24 24">
                <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.513 2.262 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.504-5.714-1.466L0 24zm10.102-4.103c1.55.918 3.076 1.4 4.872 1.401 5.433-.001 9.854-4.385 9.858-9.76.002-2.605-1.01-5.053-2.85-6.897-1.84-1.844-4.29-2.859-6.892-2.86-5.441 0-9.862 4.385-9.866 9.76-.001 1.942.512 3.834 1.488 5.495L5.78 20.6l3.35-.877.086.05-.057-.876zm7.25-5.597c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/>
              </svg>
              WhatsApp Me
            </a>
          </div>
          ...
          <div className="contact-info-col">
            ...
            <div className="contact-socials-wrapper">
              ...
              <div className="contact-socials-grid">
                ...
                <a href="https://youtube.com/playlist?list=PLchZR5tb4gCM&si=8LH63vfK5KdcaclH" target="_blank" rel="noopener noreferrer" className="social-circle">
                  <svg viewBox="0 0 24 24">
                ...
                <a href="https://www.facebook.com/profile.php?id=61591991259016" target="_blank" rel="noopener noreferrer" className="social-circle">
                  <svg viewBox="0 0 24 24">
